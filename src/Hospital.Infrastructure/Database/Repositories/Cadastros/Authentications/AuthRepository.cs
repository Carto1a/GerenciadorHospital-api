...
/*     /1* public async Task<bool> CheckIfCadastroExistsAsync(TRegister request) *1/ */
/*     /1* { *1/ */
/*     /1*     var result = await _manager.Users.FirstOrDefaultAsync(user => *1/ */
/*     /1*         user.Equals(request)); *1/ */
/*     /1*     return result != null; *1/ */
/*     /1* } *1/ */
