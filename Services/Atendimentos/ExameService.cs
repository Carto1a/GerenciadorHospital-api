...
/*     /1* public async Task<Result> Create(ExameCreationDto request) *1/ */
/*     /1* { *1/ */
...
/*     /1*     Result<List<Exame>> resultRetorn; *1/ */
...
/*     /1* { *1/ */
/*     /1*     var results = new List<Result<List<Exame>>>(); *1/ */
/*     /1*     if (page < 0) *1/ */
...
/*     /1* public Task<Result> Update(ExameUpdateDto request, Guid id) *1/ */
/*     /1* { *1/ */
