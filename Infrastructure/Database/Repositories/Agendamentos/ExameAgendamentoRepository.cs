...
: AgendamentoRepository<ExameAgendamento, AgendamentoExameGetByQuery, AgendamentoExameOutputDto>,
IExameAgendamentoRepository
{
    ...
    public override Task<List<AgendamentoExameOutputDto>> GetByQueryDtoAsync(
        AgendamentoExameGetByQuery query)
    {
        try
        {
            ...
            var result = queryCtx
                ...
                .Select(e => new AgendamentoExameOutputDto(e));
